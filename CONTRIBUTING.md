...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/sprite
   # Navigate to the newly cloned directory
   cd sprite
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/Blocss/sprite
   ```
...
3. Never work directly on `master` or `develop`. Create a new topic branch (off the latest
   version of `develop`) to contain your feature, change, or fix:
...
4. Do not use GitHub's merge button. Apply the patch to `develop` locally
...
2. Use a dedicated commit to increment the version in various files.
